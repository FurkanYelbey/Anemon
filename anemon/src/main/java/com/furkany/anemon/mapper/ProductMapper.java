package com.furkany.anemon.mapper;

import com.furkany.anemon.dto.ProductDto;
import com.furkany.anemon.dto.ProductResourceDto;
import com.furkany.anemon.dto.ProductVariantDto;
import com.furkany.anemon.entities.*;
...
public class ProductMapper {
    ...
    public Product mapToProductEntity(ProductDto productDto){
        System.out.println("DEBUG - Mapping ProductDto to Entity");
        System.out.println("DEBUG - DTO categoryId: " + productDto.getCategoryId());
        System.out.println("DEBUG - DTO categoryTypeId: " + productDto.getCategoryTypeId());
